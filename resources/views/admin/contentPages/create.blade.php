    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <div class="form-check {{ $errors->has('index') ? 'is-invalid' : '' }}">
                <input class="form-check-input" type="checkbox" name="index" id="index" value="1" {{ old('index', 0) == 1 ? 'checked' : '' }}>
        ...
        <div class="form-group">
            <div class="form-check {{ $errors->has('enabled') ? 'is-invalid' : '' }}">
                <input class="form-check-input" type="checkbox" name="enabled" id="enabled" value="1" required {{ old('enabled', 0) == 1 ? 'checked' : '' }}>
